  ...
  rowExpansionTemplate(data) {
    return (
      <div className='orders-subtable'>
        ...
        <DataTable
          value={data.orders}
          expandedRows={this.state[`expandedRowsOfParent_${data.id}`]}
          onRowToggle={(e) =>
            this.setState({ [`expandedRowsOfParent_${data.id}`]: e.data })
          }
          onRowExpand={this.onRowExpand}
          onRowCollapse={this.onRowCollapse}
          rowExpansionTemplate={(data) => <strong>{data.customer}</strong>}
          dataKey='id'>
          ...
          <Column
            ...
            body={this.searchBodyTemplate}></Column>
        </DataTable>
      </div>
    );
  }
